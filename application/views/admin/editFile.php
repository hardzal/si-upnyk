				...
				<div class="col-lg-12">
					<div class="panel panel-default">
						...
						<div class="panel-body">
							<div class="row">
								<div class="col-lg-8">
									<form role="form" method="POST" action="<?php echo base_url('admin/document/edit/' . $download->id) ?>" enctype="multipart/form-data">
										...
										<div class="form-group">
											...
											<a href="<?php echo base_url("assets/" . $download->file); ?>">Lihat File</a>
