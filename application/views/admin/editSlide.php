                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-8">
                                    <form role="form" method="POST" action="<?php echo base_url('index.php/admin/updateslide')?>" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control"  type="hidden" name="file" value="<?php echo $slide->file; ?>">
                                                <p><br><font color="red"><b>ukuran slide yang ditampilkan 460x290</b></font> (sesuaikan ukuran)</p>
                                        </div>
