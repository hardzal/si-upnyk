...
<body>
	...
	<div id="wrapper">
		...
		<div id="page-wrapper">
			<div class="row">
				<div class="col-lg-12">
					<h3 class="page-header">Edit Penelitian</h3>
				</div>
				<!-- /.col-lg-12 -->
			</div>
			<!-- /.row -->
				...
				<div class="col-lg-12">
					<div class="panel panel-default">
						<div class="panel-body">
							<div class="row">
								<div class="col-lg-12">
									<form role="form" method="POST" action="<?php echo base_url('admin/penelitian/edit/' . $tridharma->id) ?>" enctype="multipart/form-data">
										<div class="form-group">
											<label for="title">Nama Penelitian</label>
											<input class="form-control" placeholder="Penelitian" type="text" name="title" id="title" value="<?php echo $tridharma->title; ?>" required />
										</div>
										<div class="form-group">
											<div class="row">
