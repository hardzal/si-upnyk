...
<body>
	...
	<div id="wrapper">
		...
		<div id="page-wrapper">
			<div class="row">
				<div class="col-lg-12">
					<h3 class="page-header">Edit Pengabdian</h3>
				</div>
				<!-- /.col-lg-12 -->
			</div>
			<!-- /.row -->
				...
				<div class="col-lg-12">
					<div class="panel panel-default">
						<div class="panel-body">
							<div class="row">
								<div class="col-lg-12">
									<form role="form" method="POST" action="<?php echo base_url('admin/pengabdian/edit/' . $tridharma->id) ?>" enctype="multipart/form-data">
										<div class="form-group">
											<label for="title">Nama Pengabdian</label>
											<input class="form-control" placeholder="Pengabdian" type="text" name="title" id="title" value="<?php echo $tridharma->title; ?>" required />
										</div>
										<div class="form-group">
											<div class="row">
												<label for="image" class="col-form-label col-md-12">Gambar</label>
												<?php if ($tridharma->image) : ?>
													<div class="col-md-12 my-5">
														<img src="<?php echo base_url($tridharma->image); ?>" width="300px" class="img-thumbnail" />
													</div>
												<?php endif; ?>
											</div>
