		...
		<div class="container">
			<div class="row no-gutters slider-text align-items-center justify-content-center">
				<div class="col-md-9 ftco-animate text-center">
					<h1 class="mb-2 bread">Berita Mahasiswa</h1>
					<p class="breadcrumbs"><span class="mr-2"><a href="index.html">Berita <i class="ion-ios-arrow-forward"></i></a></span> <span>Mahasiswa <i class="ion-ios-arrow-forward"></i></span></p>
				</div>
			</div>
		</div>
	</section>
									...
									<div class="col-md-6 col-lg-4 ftco-animate">
										<div class="blog-entry">
											<a href="blog-single.html" class="block-16 d-flex align-items-end">
												<img class="img-terkini w-100" src="<?php echo base_url($data->file) ?>" style="height: 250px;" alt="<?php echo $data->file ?>">
											...
											<div class="text bg-white p-4">
												<h3 class="heading"><a href="<?php echo base_url('home/detailberita/' . $data->id) ?>"><?php echo $data->judul; ?></a></h3>
