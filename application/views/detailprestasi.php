      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
            <h1 class="mb-2 bread">Detail Prestasi</h1>
            <p class="breadcrumbs">
              <span class="mr-2">Prestasi <i class="ion-ios-arrow-forward"></i></span>
        ...
        <div class="row">
          ...
          <div class="container">
            ...
            <h4 class="font-weight-bold">
              <?php echo $prestasi->title; ?>
            </h4>
            <!-- Tanggal Berita -->
            <small>
              <p class="text-uppercase"><i class="far fa-calendar-alt"></i> | <?php echo date("d - F - Y", strtotime($prestasi->created_at)); ?></p>
            </small>
            <hr>
            <!-- Gambar Berita -->
            <img src="<?php echo base_url($prestasi->image)?>" class="img-fluid mb-3 foto-berita" alt="gambar">
            <!-- Isi Berita -->
            <p>
              <?php echo html_entity_decode($prestasi->description); ?>
            </p>
            <hr>
          </div>
