<nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
	<div class="navbar-header">
		...
		<a class="navbar-brand" href="<?php echo base_url('dosen'); ?>">Administrator|Dosen</a>
	</div>
	<!-- /.navbar-header -->
	...
	<ul class="nav navbar-top-links navbar-right">
		...
		<li class="dropdown">
			...
			<ul class="dropdown-menu dropdown-user">
				<li><a href="<?php echo base_url('dosen/profadmin') ?>"><i class="fa fa-user fa-fw"></i> User Profile</a>
				</li>
				<li class="divider"></li>
	...
	<div class="navbar-default sidebar" role="navigation">
		<div class="sidebar-nav navbar-collapse">
			<ul class="nav" id="side-menu">
				...
				<li>
					<a href="<?php echo base_url('dosen/index') ?>"><i class="fa fa-dashboard fa-fw"></i> Beranda</a>
				</li>
				<li>
					<a href="<?php echo base_url('dosen/Berita') ?>"><i class="fa fa-bullhorn fa-fw"></i> Informasi Dosen</a>
				</li>
				<!--  <li>
                            <a href="<?php echo base_url('index.php/admin/KPskripsi') ?>"><i class="fa fa-book fa-fw"></i> KP dan Skripsi</a>
						</li>-->
				<!-- <li>
					<a href="<?php echo base_url('dosen/agenda'); ?>"><i class="fa fa-calendar fa-fw" aria-hidden="true"></i> Agenda</a>
				</li> -->
