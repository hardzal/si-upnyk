      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
            <h1 class="mb-2 bread">Struktur Organisasi</h1>
            <p class="breadcrumbs"><span class="mr-2"><a href="index.html">Profil <i class="ion-ios-arrow-forward"></i></a></span> <span>Struktur Organisasi <i class="ion-ios-arrow-forward"></i></span></p>
          </div>
        </div>
      </div>
    </section>
      ...
      <div class="container badan">
        ...
        <div class="row" id="topSection">
          <div class="col-md-12 ftco-animate">
            ...
            <img class="w-100 img-responsive" src="<?php echo base_url('assets/images/struktur.png')?>">
            <!-- <hr> -->
            <!-- Row kurikulum -->
            <!-- <div class="row"> -->
