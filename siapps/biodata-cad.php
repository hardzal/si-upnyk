...
// ----- kabupaten ---------
	if($kabyk=='Yogyakarta'){
		...
		$k4='selected=="selected"';
	}elseif($kabyk=='Kulon Progo'){
		$k5='selected=="selected"'; }
}else{
	$almyk	= '';
	$kelyk	= '';
	$kecyk	= '';
						   ...
						   <div class="control-group">
							  ...
							  <div class="span5">
								...
								<div class="input-append date form_datetime" >
								   ...
								   placeholder="tgl-bln-thn" size="20" maxlength="10" style="width:135px";/>
						   ...
						   <div class="control-group">
							  <div class="span7">
								 ...
								 <label class="control-label" style="width:100px">
									 <input type="radio" name="jkel" value="L" <?php echo $lkel ?> />
									 Laki-laki
								 </label>
								 <label class="control-label" style="width:100px">
							  ...
							  <div class="span5">
								  ...
								  <label class="control-label" style="width:110px">Agama</label>
									 <select style="width:175px" name="agama" data-placeholder="Pilih" tabindex="3">
										<option <?php echo $a ?>>Islam</option>
										<option <?php echo $b ?>>Kristen</option>
										<option <?php echo $c ?>>Katholik</option>
										<option <?php echo $d ?>>Hindu</option>
										<option <?php echo $e ?>>Budha</option>
										<option <?php echo $f ?>>Khonghuchu</option>
									 </select>
							  </div>	 
						   </div><br>
						   <div class="control-group">
                        ...
                        <div class="widget-body form">
						   ...
						   <div class="control-group">
							 ...
							 <select  style="width:175px" name="kabyk" data-placeholder="Pilih" tabindex="1">
								<option <?php echo $k1 ?>>Yogyakarta</option>
								<option <?php echo $k2 ?>>Sleman</option>
								<option <?php echo $k3 ?>>Bantul</option>
								<option <?php echo $k4 ?>>Gunung Kidul</option>
								<option <?php echo $k5 ?>>Kulon Progo</option>
							 </select>
						   </div><br>
						   <div class="control-group">
						   ...
						   <div class="control-group">
							  <div class="span6">
								 ...
								 size="20" maxlength="20" style="width: 215px"; />
							  </div>	 
							  <div class="span6">
								 <label class="control-label" style="width:94px">Kecamatan</label>
								 <input type="text" name="kecasal" value="<?php echo $kecasl ?>"
								 size="20" maxlength="20" style="width: 245px"; />
							  </div>
						   </div><br>
						   <div class="control-group">
							  <div class="span6">
                        ...
                        <div class="widget-body form">
						   ...
						   <div class="control-group">
							  <label class="control-label" style="width:140px">Alamat</label>
								 ...
								 size="35" maxlength="35" style="width: 600px"; />
						   </div><br>
						   <div class="control-group">
							  <div class="span6">
								 <label class="control-label" style="width:140px">Kelurahan</label>
