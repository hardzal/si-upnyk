      ...
      <div id="main-content"> 
         ...
         <div class="container-fluid">
			...
			<ul class="breadcrumb">
				...
				<li><a href="#">Change</a> <span class="divider">&nbsp;</span></li>
            ...
            <div class="row-fluid">
				...
				<!-- BEGIN LOGIN FORM -->
					...
					if (isset($_POST['chgpw'])){ 
						...
						if($pwlama==$password){
							mysql_query("UPDATE login SET password='$pwbaru' WHERE username='$username' AND password = '$password'");
							$_SESSION['pw'] = $pwbaru;  ?>
							...
							<?php echo "<script>setTimeout(\"location.href = 'change_pw_adm.php';\",2200);</script>";	
						}
					} ?>
				</div>
           </div>
