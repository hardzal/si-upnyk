...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 03, 2020 at 08:02 AM
...
('124170017', 'Dirgantara', 'Catur Tunggal', 'Depok', 'Sleman', 'Bogor', 'Pisan', 'Gaincu', 'Bogor', 'Jawa Barat');
...
INSERT INTO `biodata` (`nim`, `nama`, `tmp_lahir`, `tgl_lahir`, `jkel`, `agama`, `email`, `telp`, `foto`, `tgl_masuk`, `tgl_lulus`) VALUES
('124170017', 'ALIYA PUTRI DEWINTHA', 'Bogor', '1985-01-01', 'P', 'Budha', 'ali@gmail.com', '081122233333', 'myphoto4x6.jp', '2017-09-01', '0000-00-00');

-- --------------------------------------------------------

--
-- Table structure for table `buffer_nilai`
--

CREATE TABLE IF NOT EXISTS `buffer_nilai` (
  `IDmka` tinyint(4) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `buffer_nilai`
--

INSERT INTO `buffer_nilai` (`IDmka`, `kode`, `mka`, `sem`, `sks`, `nilai`) VALUES
(1, '1000012', 'Pendidikan Agama Islam', '1', 2, 'A'),
(2, '1000022', 'Pendidikan Agama Kristen', '1', 2, ''),
(3, '1000032', 'Pendidikan Agama Katholik', '1', 2, ''),
(4, '1000042', 'Pendidikan Agama Hindu', '1', 2, ''),
(5, '1000052', 'Pendidikan Agama Budha', '1', 2, ''),
(6, '1000062', 'Pendidikan Agama Kong Hu Cu', '1', 2, ''),
(7, '1240012', 'Pengantar Teknologi Informasi dan Komunikasi', '1', 2, ''),
(8, '1000072', 'Pancasila', '1', 2, 'B'),
(9, '1240023', 'Algoritma dan Pemrograman I', '1', 3, 'A'),
(10, '1240033', 'Kalkulus', '1', 3, 'C'),
(11, '1200012', 'Konsep Teknologi', '1', 2, 'D'),
(12, '1240043', 'Manajemen Basis Data', '1', 3, 'B'),
(13, '1000101', 'Olah Raga I', '1', 1, 'C'),
(14, '1240051', 'Praktikum Manajemen Basis Data', '1', 1, 'A'),
(15, '1240061', 'Praktikum Algoritma Pemrograman I', '1', 1, 'A'),
(16, '1000132', 'Bahasa Inggris', '2', 2, 'E'),
(17, '1240073', 'Pengantar Sistem Informasi', '2', 3, 'B+'),
(18, '1240083', 'Algoritma dan Pemrograman II', '2', 3, 'C+'),
(19, '1000092', 'Bela Negara dan Widya Mwat Yasa', '2', 2, ''),
(20, '1240092', 'Dasar-Dasar Manajemen', '2', 2, ''),
(21, '1240102', 'Pemrograman Web', '2', 2, ''),
(22, '1000111', 'Olah Raga II', '2', 1, ''),
(23, '1000082', 'Pendidikan Kewarganegaraan', '2', 2, ''),
(24, '1240111', 'Praktikum Algoritma Pemrograman II', '2', 1, ''),
(25, '1240121', 'Praktikum Pemrograman Web', '2', 1, ''),
(26, '1240133', 'Struktur Data', '3', 3, ''),
(27, '1240143', 'Matematika Diskrit', '3', 3, ''),
(28, '1240152', 'Statistika Bisnis', '3', 2, ''),
(29, '1240162', 'Sistem Operasi', '3', 2, ''),
(30, '1240173', 'Pemrograman Berorintasi Objek', '3', 3, ''),
(31, '1000122', 'Bahasa Indonesia', '3', 2, ''),
(32, '1240182', 'Teori dan Perilaku Organisasi', '3', 2, ''),
(33, '1240191', 'Praktikum Struktur Data', '3', 1, ''),
(34, '1240201', 'Praktikum Pemrograman Berorientasi Objek', '3', 1, ''),
(35, '1240213', 'Jaringan Komputer', '4', 3, ''),
(36, '1240223', 'Interaksi Manusia dan Komputer', '4', 3, ''),
(37, '1240222', 'Interaksi Manusia dan Komputer', '4', 2, ''),
(38, '1240233', 'Arsitektur dan Organisasi Komputer', '4', 3, ''),
(39, '1240232', 'Arsitektur dan Organisasi Komputer', '4', 2, ''),
(40, '1240243', 'E-Commerce', '4', 3, ''),
(41, '1240253', 'Pemrograman Mobile', '4', 3, ''),
(42, '1240262', 'Informatika Sosial', '4', 2, ''),
(43, '1240271', 'Praktikum Pemrograman Mobile', '4', 1, ''),
(44, '1240272', 'Pemodelan Proses Bisnis', '4', 2, ''),
(45, '1240281', 'Praktikum Pemrograman Mobile', '4', 1, ''),
(46, '1240291', 'Praktikum Jaringan Komputer', '4', 1, ''),
(47, '1200022', 'Technopreneurship', '5', 2, ''),
(48, '1240293', 'Rancang Bangun Perangkat Lunak', '5', 3, ''),
(49, '1240303', 'Sistem Informasi Akuntansi', '5', 3, ''),
(50, '1240312', 'Manajemen Sains', '5', 2, ''),
(51, '1240323', 'Manajemen Investasi TI', '5', 3, ''),
(52, '1240343', 'Sistem Informasi Geografi', '5', 3, ''),
(53, '1240351', 'Praktikum Sistem Informasi Geografi', '5', 1, ''),
(54, '1240361', 'Praktikum Rancang Bangun Perangkat Lunak', '5', 1, ''),
(55, '1240373', 'Analisis dan Desain Sistem Informasi', '6', 3, ''),
(56, '1240382', 'Manajemen Proyek Perangkat Lunak', '6', 2, ''),
(57, '1241383', 'Manajemen Proyek Perangkat Lunak', '6', 3, ''),
(58, '1240392', 'Data Mining dan Data Warehousing', '6', 2, ''),
(59, '1241393', 'Sistem Pendukung Keputusan', '6', 3, ''),
(60, '1240402', 'Proteksi Aset Informasi', '6', 2, ''),
(61, '1241403', 'Proteksi Aset Informasi', '6', 3, ''),
(62, '1240413', 'Kerja PraktIk', '6', 3, ''),
(63, '1241412', 'Metodologi Penulisan Ilmiah', '6', 2, ''),
(64, '1240421', 'Praktikum Data Mining dan Data Warehousing', '6', 1, ''),
(65, '1240431', 'Praktikum Proteksi Aset Informasi', '6', 1, ''),
(66, '1240503', 'Manajemen Pengelolaan Lapangan Migas', '6', 3, ''),
(67, '1240513', 'Manajemen Pengelolaan Tambang', '6', 3, ''),
(68, '1240523', 'Manajemen Bencana', '6', 3, ''),
(69, '1240533', 'Manajemen Lingkungan, Mineral dan Energi', '6', 3, ''),
(70, '1240543', 'Manajemen Kualitas TI', '6', 3, ''),
(71, '1240553', 'Manajemen Resiko dan Kualitas TI', '6', 3, ''),
(72, '1240563', 'Sistem Pendukung Keputusan', '6', 3, ''),
(73, '1240573', 'Manajemen Rantai Pasok', '6', 3, ''),
(74, '1240583', 'Integrasi Aplikasi Korporasi', '6', 3, ''),
(75, '1240593', 'Bisnis Cerdas', '6', 3, ''),
(76, '1240603', 'Arsitektur Enterprise', '6', 3, ''),
(77, '1240613', 'Pengelolaan Transaksi Elektronik', '6', 3, ''),
(78, '1240623', 'Forensika Digital', '6', 3, ''),
(79, '1241563', 'Teknologi Cloud Computing', '6', 3, ''),
(80, '1240663', 'Manajemen Layanan TI', '6', 3, ''),
(81, '1240643', 'Desain Pengalaman Pengguna (UX Design)', '7', 3, ''),
(82, '1240442', 'Metodologi Penulisan Ilmiah', '7', 2, ''),
(83, '1240452', 'Uji Kualitas Perangkat Lunak', '7', 2, ''),
(84, '1240463', 'Tata Kelola dan Audit SI', '7', 3, ''),
(85, '1240652', 'Manajemen Hubungan Pelanggan', '7', 2, ''),
(86, '1240473', 'Tugas Akhir I', '7', 3, ''),
(87, '1240482', 'Kapita Selekta', '8', 2, ''),
(88, '1000143', 'Kuliah Kerja Nyata', '8', 3, ''),
(89, '1240493', 'Tugas Akhir II', '8', 3, '');
...
(1, 'Bambang Yuwono, S.T., M.T.', '2 7302 00 0225 1'),
(2, 'Nur Heri Cahyana, S.T., M.Kom.', '1960 0922 1984 03 1001'),
(3, 'Agus Sasmito A, S.Kom., M.Cs.', '1975 0412 2005 01 1001'),
(4, 'Budi Santosa, S.Si., M.T.', '2 7009 02 0234 1'),
(5, 'Dr. Awang H Pratomo, S.T., M.T.', '1977 0725 2005 01 1001'),
(6, 'Dr. Herlina Jayadianti, S.T., M.T.', '2 7706 11 0301 1'),
(7, 'Dr. Heriyanto, A.Md., S.Kom., M.Cs.', '2 7706 11 0301 1'),
(8, 'Dessyanto Boedi P, S.T., M.T.', '2 7512 00 0229 1'),
(9, 'Frans Richard K, S.T., M.Kom.', '2 6202 95 0006 1'),
(10, 'Hafsah, S.Si., M.T.', '2 7203 97 0142 1'),
(11, 'Heru Cahya R, S.Si, .M.T.', '2 7106 96 0065 1'),
(12, 'Herry Sofyan, S.T., M.Kom.', '2 6404 96 0139 1'),
(13, 'Hidayatulah H, S.T., M.M., M.Eng', '1976 1224 2005 01 1001'),
(14, 'Juwairiah, S.Si., M.T.', '2 7607 00 0230 1'),
(15, 'Mangaras Yanu F, ST., M.Eng.', '2 8201 13 0425 1'),
(16, 'Oliver Samuel S,S.Kom., M.Eng.', '2 8305 11 0300 1'),
(17, 'Paryati, S.T., M.Kom.', '2 7104 98 0181 1'),
(18, 'Rifky Indra P, S.Kom., M.Eng.', '2 8307 12 0418 1'),
(19, 'Simon Pulung Nugroho,  S.Kom., M.Cs.', '2 8305 11 0300 1'),
(20, 'Wilis Kaswidjanti, S.Si., M.Kom.', '2 7604 00 0226 1'),
(21, 'Yuli Fauziah, S.T., M.T.', '2 7107 98 0180 1'),
(22, 'Novrido Charibaldi, S,Kom., M.Kom.', '2 6811 96 0066 1'),
(23, 'Hari Prapcoyo, S.Kom., M.ICT', '1982 1208 2008 01 1004'),
(24, 'Andiko Putro Suryotomo, S.Kom., M.Cs.', '1985 0930 2019 03 1004'),
(25, 'Ahmad Taufiq Akbar, S.Si., M.Cs.', '1987 1118 2019 03 1012'),
(26, 'Rochmat Husaini, S.Kom., M.Kom.', '1988 0426 2019 03 1009'),
(27, 'Bagus Muhammad Akbar, S.ST., M.Kom.', '1989 0801 2019 03 1013'),
(28, 'Riza Prapascatama Agusdin, S.Kom., M.IM.', '1991 1006 2019 03 1010'),
(29, 'Sylvert Prian Tahalea, S.Si., M.Cs.', '1992 0114 2019 03 1019'),
(30, 'Shoffan Saifullah, S.Kom., M.Kom.', '1993 0128 2019 03 1013'),
(31, 'Vynska Amalia Permadi, S.Kom., M.Kom.', '1993 0825 2019 03 2027');
...
CREATE TABLE IF NOT EXISTS `kp` (
  ...
  `pemb_lap` varchar(44) NOT NULL,
  `pemb_si` varchar(44) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `kp` (`nim`, `judul`, `tempat`, `tgl_mulai`, `tgl_selesai`, `pemb_lap`, `pemb_si`) VALUES
('124170017', 'Analisis Sistem Perpustakaan', 'Kominfo Yogyakarta', '2019-12-01', '2020-01-03', 'Dra. Siti Maemunah', 'Heru Cahya R, S.Si, .M.T.'),
('124170001', 'Perancangan Sistem Digitalisasi Meseum Batik', 'Balai Besar Kerajinan dan Batik, Yogyakarta', '2019-12-26', '2020-01-26', 'Faras', 'Herry Sofyan, S.T., M.Kom.');
...
('124170001', 'Pendidikan Agama Islam', 'Bambang Yuwono, S.T., M.T.', 'Gasal', '2017/2018', 5, 4, 3, 4, 4, 4, 3, 5, 5, 4, 4, 4, 4, 5, 4, 4, 4, 4, 5, 4, 3, 4, 5, 3, 4, 3, 4, 5, 4, 4, 4, 3, 4);
...
(209, 'herry', 'Herry Sofyan', 'edf0921bff1aacbc5a6e9ec951c5e82a', 'Admin', 'Aktif');
...
(1000101, 'Olah Raga I'),
(1240051, 'Praktikum Manajemen Basis Data'),
(1240061, 'Praktikum Algoritma Pemrograman I'),
...
(1000111, 'Olah Raga II'),
(1000082, 'Pendidikan Kewarganegaraan'),
(1240111, 'Praktikum Algoritma Pemrograman II'),
(1240121, 'Praktikum Pemrograman Web'),
...
(1240191, 'Praktikum Struktur Data'),
(1240201, 'Praktikum Pemrograman Berorientasi Objek'),
(1240213, 'Jaringan Komputer'),
(1240223, 'Interaksi Manusia dan Komputer'),
(1240222, 'Interaksi Manusia dan Komputer'),
(1240233, 'Arsitektur dan Organisasi Komputer'),
(1240232, 'Arsitektur dan Organisasi Komputer'),
(1240243, 'E-Commerce'),
(1240253, 'Pemrograman Mobile'),
(1240262, 'Informatika Sosial'),
(1240271, 'Praktikum Pemrograman Mobile'),
(1240272, 'Pemodelan Proses Bisnis'),
(1240281, 'Praktikum Pemrograman Mobile'),
(1240291, 'Praktikum Jaringan Komputer'),
(1200022, 'Technopreneurship'),
(1240293, 'Rancang Bangun Perangkat Lunak'),
(1240303, 'Sistem Informasi Akuntansi'),
(1240312, 'Manajemen Sains'),
(1240323, 'Manajemen Investasi TI'),
(1240343, 'Sistem Informasi Geografi'),
(1240351, 'Praktikum Sistem Informasi Geografi'),
(1240361, 'Praktikum Rancang Bangun Perangkat Lunak'),
(1240373, 'Analisis dan Desain Sistem Informasi'),
(1240382, 'Manajemen Proyek Perangkat Lunak'),
(1241383, 'Manajemen Proyek Perangkat Lunak'),
(1240392, 'Data Mining dan Data Warehousing'),
(1241393, 'Sistem Pendukung Keputusan'),
(1240402, 'Proteksi Aset Informasi'),
(1241403, 'Proteksi Aset Informasi'),
(1240413, 'Kerja PraktIk'),
(1241412, 'Metodologi Penulisan Ilmiah'),
(1240421, 'Praktikum Data Mining dan Data Warehousing'),
(1240431, 'Praktikum Proteksi Aset Informasi'),
...
(1240553, 'Manajemen Resiko dan Kualitas TI'),
(1240563, 'Sistem Pendukung Keputusan'),
(1240573, 'Manajemen Rantai Pasok'),
(1240583, 'Integrasi Aplikasi Korporasi'),
(1240593, 'Bisnis Cerdas'),
(1240603, 'Arsitektur Enterprise'),
(1240613, 'Pengelolaan Transaksi Elektronik'),
(1240623, 'Forensika Digital'),
(1241563, 'Teknologi Cloud Computing'),
(1240663, 'Manajemen Layanan TI'),
(1240643, 'Desain Pengalaman Pengguna (UX Design)'),
(1240442, 'Metodologi Penulisan Ilmiah'),
(1240452, 'Uji Kualitas Perangkat Lunak'),
(1240463, 'Tata Kelola dan Audit SI'),
(1240652, 'Manajemen Hubungan Pelanggan'),
(1240473, 'Tugas Akhir I'),
(1240482, 'Kapita Selekta'),
(1000143, 'Kuliah Kerja Nyata'),
...
CREATE TABLE IF NOT EXISTS `nilai` (
  ...
  `nama` varchar(36) NOT NULL,
  `k1000012` varchar(2) DEFAULT NULL,
  `k1000022` varchar(10) DEFAULT NULL,
  `k1000032` varchar(10) DEFAULT NULL,
  `k1000042` varchar(10) DEFAULT NULL,
  `k1000052` varchar(10) DEFAULT NULL,
  `k1000062` varchar(10) DEFAULT NULL,
  `k1240012` varchar(10) DEFAULT NULL,
  `k1000072` varchar(10) DEFAULT NULL,
  `k1240023` varchar(10) DEFAULT NULL,
  `k1240033` varchar(10) DEFAULT NULL,
  `k1200012` varchar(10) DEFAULT NULL,
  `k1240043` varchar(10) DEFAULT NULL,
  `k1000101` varchar(10) DEFAULT NULL,
  `k1240051` varchar(10) DEFAULT NULL,
  `k1240061` varchar(10) DEFAULT NULL,
  `k1000132` varchar(10) DEFAULT NULL,
  `k1240073` varchar(10) DEFAULT NULL,
  `k1240083` varchar(10) DEFAULT NULL,
  `k1000092` varchar(10) DEFAULT NULL,
  `k1240092` varchar(10) DEFAULT NULL,
  `k1240102` varchar(10) DEFAULT NULL,
  `k1000111` varchar(10) DEFAULT NULL,
  `k1000082` varchar(10) DEFAULT NULL,
  `k1240111` varchar(10) DEFAULT NULL,
  `k1240121` varchar(10) DEFAULT NULL,
  `k1240133` varchar(10) DEFAULT NULL,
  `k1240143` varchar(10) DEFAULT NULL,
  `k1240152` varchar(10) DEFAULT NULL,
  `k1240162` varchar(10) DEFAULT NULL,
  `k1240173` varchar(10) DEFAULT NULL,
  `k1000122` varchar(10) DEFAULT NULL,
  `k1240182` varchar(10) DEFAULT NULL,
  `k1240191` varchar(10) DEFAULT NULL,
  `k1240201` varchar(10) DEFAULT NULL,
  `k1240213` varchar(10) DEFAULT NULL,
  `k1240223` varchar(10) DEFAULT NULL,
  `k1240222` varchar(10) DEFAULT NULL,
  `k1240233` varchar(10) DEFAULT NULL,
  `k1240232` varchar(10) DEFAULT NULL,
  `k1240243` varchar(10) DEFAULT NULL,
  `k1240253` varchar(10) DEFAULT NULL,
  `k1240262` varchar(10) DEFAULT NULL,
  `k1240271` varchar(10) DEFAULT NULL,
  `k1240272` varchar(10) DEFAULT NULL,
  `k1240281` varchar(10) DEFAULT NULL,
  `k1240291` varchar(10) DEFAULT NULL,
  `k1200022` varchar(10) DEFAULT NULL,
  `k1240293` varchar(10) DEFAULT NULL,
  `k1240303` varchar(10) DEFAULT NULL,
  `k1240312` varchar(10) DEFAULT NULL,
  `k1240323` varchar(10) DEFAULT NULL,
  `k1240343` varchar(10) DEFAULT NULL,
  `k1240351` varchar(10) DEFAULT NULL,
  `k1240361` varchar(10) DEFAULT NULL,
  `k1240373` varchar(10) DEFAULT NULL,
  `k1240382` varchar(10) DEFAULT NULL,
  `k1241383` varchar(10) DEFAULT NULL,
  `k1240392` varchar(10) DEFAULT NULL,
  `k1241393` varchar(10) DEFAULT NULL,
  `k1240402` varchar(10) DEFAULT NULL,
  `k1241403` varchar(10) DEFAULT NULL,
  `k1240413` varchar(10) DEFAULT NULL,
  `k1241412` varchar(10) DEFAULT NULL,
  `k1240421` varchar(10) DEFAULT NULL,
  `k1240431` varchar(10) DEFAULT NULL,
  `k1240503` varchar(10) DEFAULT NULL,
  `k1240513` varchar(10) DEFAULT NULL,
  `k1240523` varchar(10) DEFAULT NULL,
  `k1240533` varchar(10) DEFAULT NULL,
  `k1240543` varchar(10) DEFAULT NULL,
  `k1240553` varchar(10) DEFAULT NULL,
  `k1240563` varchar(10) DEFAULT NULL,
  `k1240573` varchar(10) DEFAULT NULL,
  `k1240583` varchar(10) DEFAULT NULL,
  `k1240593` varchar(10) DEFAULT NULL,
  `k1240603` varchar(10) DEFAULT NULL,
  `k1240613` varchar(10) DEFAULT NULL,
  `k1240623` varchar(10) DEFAULT NULL,
  `k1241563` varchar(10) DEFAULT NULL,
  `k1240663` varchar(10) DEFAULT NULL,
  `k1240643` varchar(10) DEFAULT NULL,
  `k1240442` varchar(10) DEFAULT NULL,
  `k1240452` varchar(10) DEFAULT NULL,
  `k1240463` varchar(10) DEFAULT NULL,
  `k1240652` varchar(10) DEFAULT NULL,
  `k1240473` varchar(10) DEFAULT NULL,
  `k1240482` varchar(10) DEFAULT NULL,
  `k1000143` varchar(10) DEFAULT NULL,
  `k1240493` varchar(10) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `nilai` (`nim`, `nama`, `k1000012`, `k1000022`, `k1000032`, `k1000042`, `k1000052`, `k1000062`, `k1240012`, `k1000072`, `k1240023`, `k1240033`, `k1200012`, `k1240043`, `k1000101`, `k1240051`, `k1240061`, `k1000132`, `k1240073`, `k1240083`, `k1000092`, `k1240092`, `k1240102`, `k1000111`, `k1000082`, `k1240111`, `k1240121`, `k1240133`, `k1240143`, `k1240152`, `k1240162`, `k1240173`, `k1000122`, `k1240182`, `k1240191`, `k1240201`, `k1240213`, `k1240223`, `k1240222`, `k1240233`, `k1240232`, `k1240243`, `k1240253`, `k1240262`, `k1240271`, `k1240272`, `k1240281`, `k1240291`, `k1200022`, `k1240293`, `k1240303`, `k1240312`, `k1240323`, `k1240343`, `k1240351`, `k1240361`, `k1240373`, `k1240382`, `k1241383`, `k1240392`, `k1241393`, `k1240402`, `k1241403`, `k1240413`, `k1241412`, `k1240421`, `k1240431`, `k1240503`, `k1240513`, `k1240523`, `k1240533`, `k1240543`, `k1240553`, `k1240563`, `k1240573`, `k1240583`, `k1240593`, `k1240603`, `k1240613`, `k1240623`, `k1241563`, `k1240663`, `k1240643`, `k1240442`, `k1240452`, `k1240463`, `k1240652`, `k1240473`, `k1240482`, `k1000143`, `k1240493`) VALUES
('124170017', 'ALIYA PUTRI DEWINTHA', 'A', '', '', '', '', '', '', 'B', 'A', 'C', 'D', 'B', 'C', 'A', 'A', 'E', 'B+', 'C+', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '');

-- --------------------------------------------------------

--
-- Table structure for table `option_login`
--

CREATE TABLE IF NOT EXISTS `option_login` (
...
--
-- Dumping data for table `option_login`
--

INSERT INTO `option_login` (`IDlog`, `label`, `status`) VALUES
(1, 'Admin', 'Admin'),
(2, 'Dosen', 'Dosen'),
(3, 'Mhs', 'Mahasiswa');
...
INSERT INTO `pembimbing` (`ID`, `nama`, `nip`) VALUES
(1, 'Bambang Yuwono, S.T., M.T.', '2 7302 00 0225 1'),
(2, 'Nur Heri Cahyana, S.T., M.Kom.', '1960 0922 1984 03 1001'),
(3, 'Agus Sasmito A, S.Kom., M.Cs.', '1975 0412 2005 01 1001'),
(4, 'Budi Santosa, S.Si., M.T.', '2 7009 02 0234 1'),
...
(1, 'Dosen menyediakan silabus mata kuliah', '5.00'),
(2, 'Dosen mendiskusikan silabus dengan mahasiswa', '4.00'),
(3, 'Dosen menyediakan bahan bacaan yang sesuai dengan materi silabus', '3.00'),
(4, 'Dosen memperlihatkan penguasaan materi mata kuliah', '4.00'),
(5, 'Dosen mengajarkan materi dengan metode yang efektif', '4.00'),
(6, 'Dosen selalu memberi contoh konkrit setiap menjelaskan suatu hal', '4.00'),
(7, 'Dosen sangat komunikatif', '3.00'),
(8, 'Dosen menciptakan suasana kelas yang kondusif / membuat mahasiswa termotivasi', '5.00'),
(9, 'Dosen mengajar tidak terlalu cepat / lambat, sehingga mudah dimengerti mahasiswa', '5.00'),
(10, 'Dosen selalu memberi kesempatan mahasiswa untuk bertanya', '4.00'),
(11, 'Materi dari mata kuliah telah menambah / memperluas pengetahuan dan wawasan mahasiswa', '4.00'),
(12, 'Mahasiswa puas setelah mengikuti perkuliahan mata kuliah tersebut', '4.00'),
(13, 'Mata kuliah tersebut sangat mudah dipahami mahasiswa', '4.00'),
(14, 'Dosen menciptakan suasana kelas yang menyenangkan', '5.00'),
(15, 'Dosen memperlihatkan sikap menghormati mahasiswa dan mendorong / memotivasi mahasiswa', '4.00'),
(16, 'Dosen terampil menggunakan teknologi modern dalam memberi kuliah', '4.00'),
(17, 'Dosen selalu mengembalikan hasil tes / tugas kepada mahasiswa dalam waktu yang wajar', '4.00'),
(18, 'Dosen tidak banyak bercerita tentang hal diluar materi mata kuliah yang bersangkutan', '4.00'),
(19, 'Buku tes untuk mata kuliah tersebut mudah didapat', '5.00'),
(20, 'Materi mata kuliah selalu diperbaharui dengan contoh atau perkembangan terakhir', '4.00'),
(21, 'Isi buku teks / bahan mata kuliah mudah dipahami', '3.00'),
(22, 'Dosen selalu hadir memberi kuliah setiap pertemuan', '4.00'),
(23, 'Dosen hadir di kelas tepat waktu', '5.00'),
(24, 'Dosen tidak pernah meniadakan kuliah tanpa alasan', '3.00'),
(25, 'Dosen meninggalkan kelas tepat waktu', '0.00'),
(26, 'Dosen memberi penilaian yang obyektif', '3.00'),
(27, 'Dosen selalu memberi penjelasan tentang cara menilai', '4.00'),
(28, 'Dosen selalu mengembalikan hasil tes / tugas dengan catatan / komentar', '5.00'),
(29, 'Materi tugas, tes, dan ujian sesuai dengan materi mata kuliah dan selaras dengan isi silabus', '4.00'),
(30, 'Dosen selalu mengembalikan hasil tes / tugas kepada mahasiswa dalam waktu yang wajar', '4.00'),
(31, 'Dosen mudah ditemui diluar kelas', '4.00'),
(32, 'Dosen berwibawa dimata mahasiswa', '3.00'),
(33, 'Dosen memberi pendidikan tentang nilai (values), moral, etika selain tentang materi mata kuliah', '4.00');
...
CREATE TABLE IF NOT EXISTS `ta` (
  ...
  `tgl_selesai` date NOT NULL,
  `pemb_1` varchar(44) NOT NULL,
  `pemb_2` varchar(44) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `ta` (`nim`, `judul`, `tempat`, `tgl_daftar`, `tgl_selesai`, `pemb_1`, `pemb_2`) VALUES
('124170017', 'Judul TA', 'UPN', '2020-01-01', '2020-06-04', 'Bambang Yuwono, S.T., M.T.', 'Nur Heri Cahyana, S.T., M.Kom.');
