                   ...
                   <?php foreach ($data->result() as $row) :?>
					...
					<div class="span6"><br>
						<table border="0px" width="100%" >
							<tr>
								<td rowspan="5" width="20%"><font face="Calibri" color="#27517b"><b>
									<img src="<?php echo base_url('assets/images/'.$row->file); ?>" width="110" height="190" class="img-responsive"></td>
								<td colspan="3" style="font-size:18px"><font face="Calibri" color="#27517b"><b><?php echo $row->nama; ?></b></td>
							</tr>
							
							<tr>
                                <td>NIP/NIK</td><td>&nbsp;:&nbsp;</td><td><?php echo $row->nip; ?></td>
							</tr>
							<tr>
								<td>Pendidikan</td><td>&nbsp;:&nbsp;</td><td><?php echo $row->pendidikan; ?></td>
							</tr>
							<tr>
								<td>Bidang</td><td>&nbsp;:&nbsp;</td><td><?php echo $row->bidang; ?></td>
							</tr>
