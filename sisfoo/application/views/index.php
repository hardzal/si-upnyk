			...
			<div class="slider">
				...
				<div class="flexslider">
					<ul class="slides">
                        ...
                        ?>
						<li> 
							<img class="resize" src="<?php echo base_url('assets/images/'. $data->file)?>" alt="" />
...
<?php } ?>
		...
		<div class="row">
			<div class="span8">
				<div class="title"><h3>BERITA TERBARU</h3></div>
				...
				<div class="span8">
					<div class="icons-box-vert">
						<img src="<?php echo base_url('assets/images/'.$data->file)?>" width="25%">
						<div class="icons-box-vert-info">
							<h4><b style="color:#043a6f; font-family:calibri"><a href="<?php echo base_url('index.php/sisfo/detailberita/'.$data->id)?>"><?php echo $data->judul; ?></a></b></h4>
				...
				<div>
				<p align="center"><br><a class="btn btn-info btn-xs" href="<?php echo base_url('index.php/sisfo/berita') ?>">Lihat lainnya &raquo;</a></p>
				</div>
			</div>
			<div class="span4">
